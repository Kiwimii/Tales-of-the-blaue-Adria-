...
export const AERIAL_REGION_LAYOUT: Record<RegionId, Bounds> = {
  ...
  beach: { x: 200, y: 250, width: 650, height: 1200 },
  cove: { x: 0, y: 1450, width: 850, height: 350 },
};
...
export const AERIAL_ROADS: PlanRoad[] = [
  ...
  { id: 'taucher-spur', from: 'lowerHub', to: 'taucherEntry', width: 56, surface: 'gravel' },
  { id: 'taucher-pitch-access', from: 'taucherEntry', to: 'taucherCenter', width: 52, surface: 'gravel' },
  ...
  { id: 'cove-connector', from: 'lowerSouth', to: 'coveGate', width: 54, surface: 'gravel' },
  { id: 'cove-path', from: 'coveGate', to: 'coveDock', width: 52, surface: 'sand' },
];

export const AERIAL_FENCE_SEGMENTS: PlanFence[] = [
  { id: 'camp-beach-fence-north', x: 820, y: 270, width: 22, height: 830 },
  { id: 'camp-beach-fence-south', x: 820, y: 1250, width: 22, height: 220 },
];

export const BEACH_GATE = { x: 820, y: 1100, width: 22, height: 150 } as const;
...
export const OBJECT_PLACEMENTS: Record<string, Placement> = {
  ...
  sanitary: { x: 870, y: 780, width: 230, height: 170 },
  'home-tent': { x: 930, y: 1040 },
  'tent-andre': { x: 930, y: 1230 },
  ...
  'central-tree-1': { x: 860, y: 780 },
  'central-tree-2': { x: 1540, y: 1110 },
  'central-tree-3': { x: 870, y: 1380 },
  'central-flowerbed': { x: 1260, y: 1350 },
  'tent-hedge-west': { x: 880, y: 1390, width: 380 },
  'tent-hedge-east': { x: 1360, y: 1390, width: 260 },

  clubhouse: { x: 910, y: 250 },
  'north-camper-1': { x: 1200, y: 300 },
  'north-camper-2': { x: 1420, y: 270 },
  'north-camper-3': { x: 1370, y: 570, width: 220 },
  'north-table-1': { x: 980, y: 560 },
  'north-table-2': { x: 1450, y: 570 },
  'north-bench-1': { x: 1260, y: 650 },
  ...
  'cove-shelter': { x: 520, y: 1480 },
  'cove-bench': { x: 570, y: 1650 },
  'cove-sign': { x: 720, y: 1460 },
  'cove-rock-1': { x: 80, y: 1490 },
  'cove-rock-2': { x: 700, y: 1690 },
  'cove-tree-1': { x: 80, y: 1640 },
  'cove-tree-2': { x: 700, y: 1510 },
