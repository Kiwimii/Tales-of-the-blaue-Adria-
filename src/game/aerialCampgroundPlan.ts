...
export const AERIAL_REGION_LAYOUT: Record<RegionId, Bounds> = {
  arrival: { x: 450, y: 1050, width: 950, height: 750 },
...
export const AERIAL_SITE_POLYGONS: PlanPolygon[] = [
  { id: 'campground-main', fill: 0x678b59, border: 0x355f42, points: [{ x: 0, y: 0 }, { x: 1950, y: 0 }, { x: 1950, y: 1380 }, { x: 1400, y: 1380 }, { x: 1400, y: 1800 }, { x: 450, y: 1800 }, { x: 450, y: 1380 }, { x: 0, y: 1380 }] },
  { id: 'arrival-apron', fill: 0x748175, border: 0x465f4c, points: [{ x: 450, y: 1250 }, { x: 1400, y: 1250 }, { x: 1400, y: 1800 }, { x: 450, y: 1800 }] },
...
export const AERIAL_NODES = {
  entrance: { x: 900, y: 1760 },
  parkingSouth: { x: 900, y: 1650 },
  parkingWest: { x: 550, y: 1650 },
  parkingEast: { x: 1200, y: 1650 },
  gate: { x: 900, y: 1400 },
  receptionJunction: { x: 1130, y: 1400 },
  receptionDoor: { x: 1130, y: 1250 },
  mainSouth: { x: 900, y: 1300 },
  middleHub: { x: 900, y: 950 },
  upperHub: { x: 900, y: 650 },
  northHub: { x: 900, y: 300 },
  middleWest: { x: 200, y: 950 },
  middleEast: { x: 1350, y: 950 },
  upperWest: { x: 200, y: 650 },
  upperEast: { x: 1350, y: 650 },
  northWest: { x: 200, y: 300 },
  northEast: { x: 1350, y: 300 },
  festivalWest: { x: 1450, y: 650 },
  festivalCenter: { x: 1750, y: 650 },
  festivalSouth: { x: 1750, y: 950 },
  beachGateInside: { x: 1900, y: 650 },
  beachGateOutside: { x: 2000, y: 650 },
  beachPromenadeNorth: { x: 2000, y: 400 },
  beachNorth: { x: 2100, y: 400 },
  beachPromenadeSouth: { x: 2000, y: 900 },
  beachSouth: { x: 2100, y: 900 },
  dockTurn: { x: 2100, y: 500 },
  mainDock: { x: 2200, y: 500 },
  serviceWest: { x: 1450, y: 1300 },
  serviceEast: { x: 1750, y: 1300 },
  serviceSouth: { x: 1750, y: 1450 },
  coveGate: { x: 1950, y: 1450 },
  coveDock: { x: 2200, y: 1450 },
...
export const AERIAL_PITCHES: PlanPitch[] = [
  ...
  { id: 'taucher', x: 40, y: 980, width: 1320, height: 400, label: 'TAUCHERPLATZ' },
  { id: 'festival', x: 1420, y: 40, width: 500, height: 910, label: 'FESTWIESE' },
  { id: 'service', x: 1420, y: 1030, width: 500, height: 720 },
];

export const TAUCHER_PITCH_BOUNDS: Bounds = { x: 40, y: 980, width: 1320, height: 400 };
...
export const AERIAL_FUNCTIONAL_AREAS = {
  parking: { id: 'parking', label: 'PARKPLATZ UND ANKUNFT', regionId: 'arrival', x: 500, y: 1480, width: 750, height: 300, fill: 0x7d8179, border: 0xc9c0a0 },
  reception: { id: 'reception', label: 'REZEPTION UND SCHRANKENHOF', regionId: 'arrival', x: 960, y: 1040, width: 420, height: 410, fill: 0x788a72, border: 0xd5c689 },
  ...
  'taucher-tent-row': { id: 'taucher-tent-row', label: 'TAUCHERPLATZ UND ZELTGRUPPE', regionId: 'central', x: 40, y: 980, width: 1320, height: 400, fill: 0x82a96a, border: 0xf0d77e },
...
export const OBJECT_PLACEMENTS: Record<string, Placement> = {
  reception: { x: 1030, y: 1080, width: 260, height: 155 },
  'arrival-sign': { x: 650, y: 1690, width: 115, height: 70 },
  'parking-fence-left': { x: 500, y: 1500, width: 22, height: 230 },
  'parking-fence-right': { x: 1220, y: 1500, width: 22, height: 230 },
  'arrival-flowerbed': { x: 1280, y: 1120, width: 90, height: 70 },
  'arrival-lantern-1': { x: 850, y: 1530, width: 24, height: 70 },
  'arrival-lantern-2': { x: 950, y: 1320, width: 24, height: 70 },
  'lunch-sign': { x: 1240, y: 1260, width: 105, height: 65 },
  sanitary: { x: 80, y: 720, width: 255, height: 170 },
  'central-camper': { x: 400, y: 720, width: 220, height: 108 },
  'home-tent': { x: 80, y: 1030, width: 145, height: 120 },
  'tent-andre': { x: 235, y: 1030, width: 135, height: 105 },
  'tent-rene': { x: 380, y: 1030, width: 135, height: 105 },
  'tent-lars': { x: 525, y: 1030, width: 135, height: 110 },
  'tent-danny': { x: 670, y: 1030, width: 135, height: 105 },
  'central-table': { x: 980, y: 1030, width: 145, height: 72 },
  'central-bench': { x: 1150, y: 1120, width: 105, height: 38 },
  'central-sign': { x: 50, y: 950, width: 92, height: 62 },
  'central-tree-1': { x: 20, y: 700, width: 95, height: 105 },
  'central-tree-2': { x: 1280, y: 1020, width: 100, height: 112 },
  'central-tree-3': { x: 20, y: 1260, width: 82, height: 92 },
  'central-flowerbed': { x: 1050, y: 1260, width: 210, height: 52 },
  'tent-hedge-west': { x: 80, y: 990, width: 370, height: 24 },
  'tent-hedge-east': { x: 560, y: 990, width: 280, height: 24 },
  clubhouse: { x: 50, y: 50, width: 320, height: 190 },
  'north-camper-1': { x: 430, y: 90, width: 220, height: 110 },
  'north-camper-2': { x: 980, y: 90, width: 220, height: 110 },
  'north-camper-3': { x: 1050, y: 420, width: 220, height: 108 },
  'north-table-1': { x: 100, y: 400, width: 140, height: 68 },
  'north-table-2': { x: 350, y: 420, width: 140, height: 68 },
  'north-bench-1': { x: 600, y: 500, width: 115, height: 40 },
  'north-sign': { x: 50, y: 560, width: 96, height: 64 },
  'north-tree-1': { x: 10, y: 20, width: 102, height: 116 },
  'north-tree-2': { x: 1260, y: 20, width: 112, height: 125 },
  'north-tree-3': { x: 1280, y: 520, width: 92, height: 108 },
  'north-tree-4': { x: 10, y: 520, width: 100, height: 115 },
  'north-fence': { x: 0, y: 680, width: 600, height: 22 },
  'festival-stage': { x: 1450, y: 60, width: 390, height: 150 },
  party: { x: 1600, y: 400, width: 300, height: 210 },
  'festival-kiosk': { x: 1450, y: 760, width: 180, height: 115 },
  'festival-table-1': { x: 1650, y: 730, width: 145, height: 70 },
  'festival-table-2': { x: 1750, y: 830, width: 145, height: 70 },
  'festival-lantern-1': { x: 1450, y: 620, width: 24, height: 78 },
  'festival-lantern-2': { x: 1900, y: 620, width: 24, height: 78 },
  'festival-sign': { x: 1830, y: 900, width: 100, height: 66 },
  lifeguard: { x: 2050, y: 180, width: 160, height: 125 },
  'main-dock': { x: 2200, y: 460, width: 300, height: 72 },
  'beach-bench-1': { x: 2050, y: 520, width: 115, height: 40 },
  'beach-kiosk': { x: 2050, y: 720, width: 185, height: 120 },
  'beach-bench-2': { x: 2050, y: 850, width: 115, height: 40 },
  'beach-table': { x: 2050, y: 950, width: 150, height: 72 },
  'beach-sign': { x: 1960, y: 650, width: 92, height: 62 },
  'beach-rock-1': { x: 1980, y: 1000, width: 80, height: 58 },
  'beach-rock-2': { x: 2140, y: 1020, width: 62, height: 48 },
  workshop: { x: 1450, y: 1520, width: 280, height: 170 },
  'wood-shed': { x: 1750, y: 1550, width: 160, height: 105 },
  'woodland-bench': { x: 1500, y: 1650, width: 120, height: 42 },
  'woodland-sign': { x: 1800, y: 1150, width: 104, height: 68 },
  'woodland-tree-1': { x: 1400, y: 1020, width: 118, height: 132 },
  'woodland-tree-2': { x: 1840, y: 1020, width: 120, height: 138 },
  'woodland-tree-3': { x: 1400, y: 1660, width: 125, height: 140 },
  'woodland-tree-4': { x: 1830, y: 1660, width: 120, height: 136 },
  'woodland-tree-5': { x: 1600, y: 1660, width: 108, height: 125 },
  'cove-shelter': { x: 1980, y: 1180, width: 190, height: 120 },
  'cove-dock': { x: 2200, y: 1420, width: 300, height: 65 },
  'cove-bench': { x: 2000, y: 1650, width: 125, height: 42 },
  'cove-sign': { x: 1960, y: 1380, width: 108, height: 70 },
  'cove-rock-1': { x: 1980, y: 1500, width: 95, height: 68 },
  'cove-rock-2': { x: 2120, y: 1600, width: 115, height: 80 },
  'cove-tree-1': { x: 1960, y: 1700, width: 118, height: 100 },
  'cove-tree-2': { x: 2120, y: 1700, width: 120, height: 100 },
};

export const NPC_PLACEMENTS: Record<string, PlanPoint> = {
  gundula: { x: 1040, y: 1360 },
  uli: { x: 1200, y: 1360 },
  manni: { x: 1080, y: 1180 },
  ronny: { x: 1040, y: 880 },
  andre: { x: 150, y: 1190 },
  ...
  masl: { x: 1830, y: 720 },
  felix: { x: 2170, y: 940 },
  schubert: { x: 1600, y: 1220 },
  schima: { x: 2080, y: 1550 },
  susi: { x: 1650, y: 850 },
  jule: { x: 2170, y: 360 },
  kira: { x: 300, y: 500 },
};
...
export const ENTRANCE_PLACEMENTS: Record<string, PlanPoint> = {
  'reception-door': { x: 1130, y: 1250 },
  'sanitary-door': { x: 208, y: 905 },
  'home-door': { x: 152, y: 1160 },
  'party-door': { x: 1750, y: 625 },
};

export const LANDMARK_PLACEMENTS: Record<string, PlanPoint> = {
  'notice-board': { x: 1250, y: 1350 },
  campfire: { x: 1120, y: 1080 },
  'clubhouse-wall': { x: 210, y: 280 },
  'festival-lights': { x: 1680, y: 650 },
  'lake-lookout': { x: 2160, y: 500 },
  'service-map': { x: 1800, y: 1260 },
  'cove-echo': { x: 2200, y: 1450 },
};
...
export const OBJECT_AREA_ASSIGNMENTS: Record<string, FunctionalAreaId> = {
  ...
  'arrival-lantern-1': 'parking',
  reception: 'reception',
  'arrival-flowerbed': 'reception',
  'arrival-lantern-2': 'reception',
  ...
  'central-table': 'taucher-tent-row',
  'central-bench': 'taucher-tent-row',
  'central-sign': 'taucher-tent-row',
  'central-tree-2': 'taucher-tent-row',
  ...
  'beach-kiosk': 'beach-south',
  'beach-bench-2': 'beach-south',
  'beach-table': 'beach-south',
  'beach-sign': 'beach-south',
  'beach-rock-1': 'beach-south',
  'beach-rock-2': 'beach-south',
...
export const NPC_AREA_ASSIGNMENTS: Record<string, FunctionalAreaId> = {
  gundula: 'reception',
  uli: 'reception',
  manni: 'taucher-tent-row',
  ronny: 'central-services',
...
export const ARRIVAL_STORY_PLACEMENTS = {
  trunk: { x: 900, y: 1600 },
  reservationBoard: { x: 1250, y: 1350 },
  gundula: { x: 1040, y: 1360 },
  uli: { x: 1200, y: 1360 },
  gateDebate: { x: 900, y: 1400 },
  taucherplatz: { x: 1120, y: 1180 },
  powerBox: { x: 1300, y: 1160 },
  drinks: { x: 150, y: 1180 },
  tents: { x: 470, y: 1120 },
  cable: { x: 780, y: 1180 },
  firstBeer: { x: 1120, y: 1080 },
  homeDoor: { x: 152, y: 1160 },
} as const;
