...
export const AERIAL_NODES = {
  ...
  tentAccessTurn: { x: 40, y: 950 }, homeApproach: { x: 40, y: 1110 }, homeDoorNode: { x: 210, y: 1110 },
...
export const AERIAL_PITCHES: PlanPitch[] = [
  ...
  { id: 'north-social', x: 40, y: 340, width: 1320, height: 260 }, { id: 'services', x: 40, y: 690, width: 1320, height: 190 }, { id: 'taucher', x: 40, y: 880, width: 1320, height: 400, label: 'TAUCHERPLATZ · ZELTKREIS' },
  { id: 'festival', x: 1420, y: 40, width: 500, height: 910, label: 'FESTWIESE' }, { id: 'service', x: 1420, y: 1030, width: 500, height: 720 },
];
export const TAUCHER_PITCH_BOUNDS: Bounds = { x: 40, y: 880, width: 1320, height: 400 };
export const ARRIVAL_CAR_POSITION: PlanPoint = { x: 900, y: 1600 };
export const TAUCHER_CAR_POSITION: PlanPoint = { x: 1240, y: 1170 };
export const FRIEND_CAMP_CENTER: PlanPoint = { x: 650, y: 1130 };
export const FRIEND_TENT_IDS = ['home-tent', 'tent-andre', 'tent-rene', 'tent-lars', 'tent-danny'] as const;
...
export const AERIAL_FUNCTIONAL_AREAS = {
  ...
  'north-social': { id: 'north-social', label: 'ADRIA-KLAUSE UND SITZBEREICH', regionId: 'north', x: 40, y: 340, width: 1320, height: 350, fill: 0x739861, border: 0xb3ca8d },
  'central-services': { id: 'central-services', label: 'SANITÄR UND DAUERCAMPER', regionId: 'central', x: 40, y: 690, width: 1320, height: 190, fill: 0x759b63, border: 0xb6ce8f },
  'taucher-tent-row': { id: 'taucher-tent-row', label: 'TAUCHERPLATZ UND BEGEHBARER ZELTKREIS', regionId: 'central', x: 40, y: 880, width: 1320, height: 400, fill: 0x82a96a, border: 0xf0d77e },
...
export const OBJECT_PLACEMENTS: Record<string, Placement> = {
  ...
  'home-tent': { x: 140, y: 1040, width: 145, height: 120 }, 'tent-andre': { x: 410, y: 990, width: 135, height: 105 }, 'tent-rene': { x: 760, y: 990, width: 135, height: 105 }, 'tent-lars': { x: 940, y: 1140, width: 135, height: 110 }, 'tent-danny': { x: 350, y: 1140, width: 135, height: 105 },
  'central-table': { x: 990, y: 1040, width: 145, height: 72 }, 'central-bench': { x: 1090, y: 1130, width: 105, height: 38 }, 'central-sign': { x: 50, y: 900, width: 92, height: 62 },
  'central-tree-1': { x: 20, y: 700, width: 95, height: 105 }, 'central-tree-2': { x: 1250, y: 930, width: 100, height: 112 }, 'central-tree-3': { x: 20, y: 1220, width: 82, height: 92 }, 'central-flowerbed': { x: 1160, y: 1230, width: 170, height: 45 },
  'tent-hedge-west': { x: 80, y: 890, width: 500, height: 24 }, 'tent-hedge-east': { x: 740, y: 890, width: 580, height: 24 },
...
export const FRIEND_TENT_ENTRY_POINTS: Record<(typeof FRIEND_TENT_IDS)[number], PlanPoint> = {
  'home-tent': { x: 212, y: 1160 },
  'tent-andre': { x: 478, y: 1100 },
  'tent-rene': { x: 828, y: 1100 },
  'tent-lars': { x: 900, y: 1130 },
  'tent-danny': { x: 495, y: 1130 },
};

export const NPC_PLACEMENTS: Record<string, PlanPoint> = {
  gundula: { x: 1180, y: 1360 }, uli: { x: 1020, y: 1350 }, manni: { x: 360, y: 850 }, ronny: { x: 1040, y: 880 },
  andre: { x: 478, y: 1100 }, rene: { x: 828, y: 1100 }, lars: { x: 900, y: 1130 }, danny: { x: 495, y: 1130 },
...
export const ENTRANCE_PLACEMENTS: Record<string, PlanPoint> = {
  'reception-door': { x: 1130, y: 1420 }, 'sanitary-door': { x: 208, y: 905 }, 'home-door': { x: 212, y: 1160 }, 'party-door': { x: 1750, y: 625 },
};

export const LANDMARK_PLACEMENTS: Record<string, PlanPoint> = {
  'notice-board': { x: 1280, y: 1360 }, campfire: { x: 650, y: 1130 }, 'clubhouse-wall': { x: 210, y: 280 }, 'festival-lights': { x: 1680, y: 650 }, 'lake-lookout': { x: 2160, y: 500 }, 'service-map': { x: 1800, y: 1260 }, 'cove-echo': { x: 2200, y: 1450 },
};
...
export const NPC_AREA_ASSIGNMENTS: Record<string, FunctionalAreaId> = {
  gundula: 'reception', uli: 'reception', manni: 'central-services', ronny: 'central-services', andre: 'taucher-tent-row', rene: 'taucher-tent-row', lars: 'taucher-tent-row', danny: 'taucher-tent-row',
...
export const ARRIVAL_STORY_PLACEMENTS = {
  trunk: { x: 900, y: 1600 }, reservationBoard: { x: 1280, y: 1360 }, gundula: { x: 1180, y: 1360 }, uli: { x: 1020, y: 1350 }, gateDebate: { x: 900, y: 1400 }, taucherplatz: { x: 1240, y: 1170 },
  powerBox: { x: 1290, y: 1080 }, drinks: { x: 1130, y: 1210 }, tents: { x: 1160, y: 1010 }, cable: { x: 1210, y: 1090 }, firstBeer: { x: 1100, y: 1170 }, homeDoor: { x: 212, y: 1160 },
} as const;
