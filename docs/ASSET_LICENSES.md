...
## Universal LPC – `/lpc-test/` und `/lpc-main/`
...
Die LPC-Dateien werden unverändert als anatomische und animierte Grundebenen geladen. Kleidung, Frisuren, Accessoires, Proportionen und Rollenmerkmale werden im Spielcode separat darüber gezeichnet. Diese neuen grafischen Overlays dürfen unter CC-BY-SA 4.0 weiterverwendet und verändert werden, solange das Projekt und die jeweiligen Urheber genannt werden.

Der `/lpc-test/`-Build dient dem direkten Figurenvergleich. Der `/lpc-main/`-Build verbindet dieselbe LPC-Basis mit dem bestehenden Spielzustand, Charaktererstellung, Einkauf, Quests, Beziehungen, Bedürfnissen, Inventar, Duell und Partyspielen. Eigene prozedurale Zusatzanimationen umfassen Atmen, Sprechen, Winken, Trinken, Jubeln, Schwanken, Trefferreaktion, Sitzen, Tragen und Handynutzung.
